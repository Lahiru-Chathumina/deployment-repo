...
export default function Modal({ post, onClose }: any) {
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-4xl w-full relative shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8">
          {!post.image_url && (
            <h2 className="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">{post.title}</h2>
          )}
